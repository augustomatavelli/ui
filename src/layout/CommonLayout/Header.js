...
import { useMediaQuery, Box, Button, Chip, Container, Drawer, Link, List, ListItemButton, ListItemIcon, ListItemText, Stack, Toolbar, Typography, useScrollTrigger } from "@mui/material";
				...
				<Container disableGutters={matchDownMd}>
					<Toolbar sx={{ px: { xs: 1.5, md: 0, lg: 0 }, py: 2 }}>
						...
						<Stack
							...
							spacing={2}
						>
							<Link className="header-link" color="white" component={RouterLink} to="/" target="_blank" underline="none">
								Dashboard
							</Link>
							<Link className="header-link" color={handleDrawerOpen ? "primary" : "white"} component={RouterLink} to="/components-overview/buttons" underline="none">
								Components
							</Link>
						...
						>
							...
							<Stack direction="row" spacing={2}>
								{layout === "component" && (
									<Button variant="outlined" size="small" color="warning" component={RouterLink} to={APP_DEFAULT_PATH} sx={{ mt: 0.5, height: 28 }}>
										Dashboard
									</Button>
								)}
								{layout !== "component" && (
									<Button variant="outlined" size="small" color="warning" component={RouterLink} to="/components-overview/buttons" sx={{ mt: 0.5, height: 28 }}>
										All Components
									</Button>
								)}
							...
							<Drawer anchor="top" open={drawerToggle} onClose={drawerToggler(false)} sx={{ "& .MuiDrawer-paper": { backgroundImage: "none" } }}>
								<Box
									sx={{
										width: "auto",
