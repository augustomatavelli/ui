...
import { Box, ClickAwayListener, List, ListItemButton, ListItemIcon, ListItemText, Paper, Popper, Typography, useMediaQuery } from "@mui/material";
		...
		<>
			{menuOrientation === MenuOrientation.VERTICAL || downLG ? (
				...
				<List>
					...
					>
						{itemIcon && <ListItemIcon sx={{ minWidth: 28 }}>{currentItem.id === lastItemId ? <DownOutlined style={{ fontSize: 20, stroke: "1.5" }} /> : itemIcon}</ListItemIcon>}
						<ListItemText
							sx={{ mr: 1 }}
							primary={
								<Typography variant="body1" color={selectedID === currentItem.id ? theme.palette.primary.main : theme.palette.secondary.dark}>
