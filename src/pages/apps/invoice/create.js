...
import { customerPopup, toggleCustomerPopup, selectCountry, getInvoiceInsert, reviewInvoicePopup, getInvoiceList } from "store/reducers/invoice";
								...
								<Grid item xs={12} sm={6} md={3}>
									<Stack spacing={1}>
										...
										<FormControl sx={{ width: "100%" }}>
											<TextField required disabled type="number" name="invoice_id" id="invoice_id" value={values.invoice_id} onChange={handleChange} />
										</FormControl>
									</Stack>
								</Grid>
								<Grid item xs={12} sm={6} md={3}>
															...
															<Grid item xs={12}>
																<Stack spacing={2}>
																	...
																	<Stack direction="row" justifyContent="space-between">
																		...
																		<Typography variant="subtitle1">{total % 1 === 0 ? country?.prefix + "" + total : country?.prefix + "" + total.toFixed(2)}</Typography>
																	</Stack>
																</Stack>
															</Grid>
														</Grid>
								...
								<Grid item xs={12} sm={6}>
									<Stack spacing={1}>
										...
										<FormControl sx={{ width: { xs: "100%", sm: 250 } }}>
											id="country-select-demo" fullWidth options={countries}
											...
											{(props, option) => (
												<Box component="li" sx={{ "& > img": { mr: 2, flexShrink: 0 } }} {...props}>
													{option.code && <img loading="lazy" width="20" src={`https://flagcdn.com/w20/${option.code.toLowerCase()}.png`} alt="" />}
													{option.label}
												</Box>
											)}
											renderInput=
															...
															startAdornment: (
																<>
																	{selected && selected.code !== "" && (
																		<img style={{ marginRight: 6 }} loading="lazy" width="20" src={`https://flagcdn.com/w20/${selected.code.toLowerCase()}.png`} alt="" />
																	)}
																</>
															),
														}}
