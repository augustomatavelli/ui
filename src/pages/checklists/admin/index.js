...
import ChecklistsTable from "sections/tables/checklists";

const ListChecklistsForAdmin = () => {
	...
	return (
		...
		>
			<ChecklistsTable openFilter={openFilter} reload={reload} />
		</MainCard>
	);
};

export default ListChecklistsForAdmin;
